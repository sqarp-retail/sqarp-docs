...
You can create and enrich your inspirationals in the **SQARP Basic Bulk Editing Template**:  
...
Three groups of inspirational entities exist in the SQARP Basic Bulk Editing Template. You can create any number of entities within each group:
