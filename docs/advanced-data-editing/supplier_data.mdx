...
<ReactPlayer width="100%" height="500" playing loop="true" controls url='/vid/Supplier.mp4' />
...
| supplier\_minimum\_order\_quantity | The minimum number of packaging units that must be purchased in a single order. | Must be positive numeric value. |
