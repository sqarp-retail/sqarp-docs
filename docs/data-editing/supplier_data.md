...
| market\_slug | Identifier for the market the supplier data refers to | Must be ISO 3166-1 Alpha-3, see below |
| supplier\_article\_number | The suppliers unique identifier for the product |No validation|
...
| supplier\_product\_title\_[lang] | The suppliers name for the product in the specified language |No validation|
...
| supplier\_delivery\_notes\_[lang] | Delivery notes for the product in the specified language. | No validation |
...
| supplier\_recommended\_price\_currency\_slug | The currency corresponding to the recommended retail price of the product. | No validation |
...
<iframe width="100%" height="400" src="https://sqarp.retool.com/embedded/public/c793aef2-fd76-43fe-ae87-a38b796d4540" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
